pipeline {
    ...
    environment {
        GIT_REPO_URL = 'https://github.com/harishb2907/devopspipeline.git'
        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/harishb2907/devopspipeline.git']]])
                }
            }
        }
